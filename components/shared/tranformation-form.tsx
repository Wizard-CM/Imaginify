...
import { CustomField } from "./custom-feild";
import {
  Select,
  SelectContent,
  SelectItem,
...
import { addImage, updateImage } from "@/lib/actions/images.actions";
import { InsufficientCreditsModal } from "./insufficient-modal";
...
const TranformationForm = ({
  ...
  const onSelectFieldHandler = (
    value: string,
    onChangeFeild: (value: string) => void
  ) => {
  ...
  const onInputChangeHandler = (
    ...
    debounce(() => {
      setNewTransformation((prev: any) => ({
        ...
        [type]: {
          ...prev?.[type],
          [feildName === "prompt" ? "prompt" : "to"]: value,
        },
      }));
    }, 1000)();
